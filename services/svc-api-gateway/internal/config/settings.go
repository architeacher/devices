...
type (
	ServiceConfig struct {
		...
		HTTPServer    HTTPServerConfig    `json:"http_server_server"`
	...
	AppConfig struct {
		ServiceName    string `envconfig:"APP_SERVICE_NAME" default:"api-gateway" json:"service_name"`
	...
	TelemetryConfig struct {
		...
		ServiceName    string  `envconfig:"OTEL_SERVICE_NAME" default:"api-gateway" json:"service_name"`
	...
	SecretStorageConfig struct {
		...
		MountPath     string        `envconfig:"VAULT_MOUNT_PATH" default:"api-gateway" json:"mount_path"`
	...
	AuthConfig struct {
		...
		ValidIssuers   []string      `envconfig:"AUTH_VALID_ISSUERS" default:"api-gateway,auth-service" json:"valid_issuers"`
